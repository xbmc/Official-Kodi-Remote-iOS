...
- (void)cancel {
    ...
    if (self.dataTask) {
        ...
        // As we cancelled the dataTask, its callback won't be called and thus won't
...
- (void)URLSession:(NSURLSession*)session dataTask:(NSURLSessionDataTask*)dataTask willCacheResponse:(NSCachedURLResponse*)cachedResponse completionHandler:(void (^)(NSCachedURLResponse*))completionHandler {
