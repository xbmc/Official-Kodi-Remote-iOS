...
#define BACKGROUND_ARTWORK_VERY_WEAK_ALPHA 0.05
#define BACKGROUND_ARTWORK_WEAK_ALPHA 0.1
#define BACKGROUND_ARTWORK_MEDIUM_ALPHA 0.2
#define BACKGROUND_ARTWORK_VERY_STRONG_ALPHA 0.9
