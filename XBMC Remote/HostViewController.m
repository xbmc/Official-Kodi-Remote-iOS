...
- (void)updateUI {
    ...
    switch (services.count) {
        case 0:
            [noInstances animateX:0 alpha:1.0 duration:0.3];
            break;
...
- (IBAction)openHelpWiki:(id)sender {
    [self openURL:@"https://kodi.wiki/view/Smartphone/tablet_remotes"];
}

- (IBAction)openHelpForum:(id)sender {
    [self openURL:@"https://forum.kodi.tv/showthread.php?tid=372379"];
}
