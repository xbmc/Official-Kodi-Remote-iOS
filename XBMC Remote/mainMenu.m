...
+ (NSMutableArray*)generateMenus {
    ...
    NSMutableArray *mainMenuItems = [NSMutableArray arrayWithCapacity:1];
...
#pragma mark - Now Playing Right Menu
    ...
    AppDelegate.instance.nowPlayingMenuItems = @[nowPlayingItem1];
...
#pragma mark - Remote Control Right Menu
    ...
    AppDelegate.instance.remoteControlMenuItems = @[remoteControlItem1];
