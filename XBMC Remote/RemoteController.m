...
- (UIImage*)getImageForRemoteMode {
    UIImage *gestureImage = isGestureViewActive ? [UIImage imageNamed:@"icon_remote"] : [UIImage imageNamed:@"icon_finger"];
...
- (void)createRemoteToolbarWidth:(CGFloat)width xMin:(CGFloat)xMin yMax:(CGFloat)yMax {
    ...
    remoteToolbar = [[UIView alloc] initWithFrame:CGRectMake(xMin, yMax - TOOLBAR_HEIGHT, width - xMin, TOOLBAR_HEIGHT)];
