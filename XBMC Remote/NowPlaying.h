...
@interface NowPlaying : UIViewController <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, SDWebImageManagerDelegate, UIGestureRecognizerDelegate>{
    DSJSONRPC *jsonRPC;
